...
def update_settings():
    ...
    # Simple migration if columns don't exist
    for col in ["app_theme", "app_bg_color", "google_client_id"]:
        try: conn.execute(f"ALTER TABLE settings ADD COLUMN {col} TEXT DEFAULT ''")
        except: pass
